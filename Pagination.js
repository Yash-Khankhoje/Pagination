...
paginationList.setAttribute('class', 'pagination pagination-position');

let First = document.createElement('a');
First.setAttribute('href', '#');
First.innerHTML="First"
First.setAttribute('id', 'firstId');
First.setAttribute('onclick', 'tableDisplay(this.id)');

let Previous = document.createElement('a');
Previous.setAttribute('href', '#');
Previous.innerHTML="Previous";
Previous.setAttribute('id', 'firstId');
Previous.setAttribute('onclick', 'tableDisplay(this.id)');

let Second = document.createElement('a');
Second.setAttribute('href', '#');
Second.innerHTML="2"
Second.setAttribute('id', 'secondId');
Second.setAttribute('onclick', 'tableDisplay(this.id)');

let Third = document.createElement('a');
Third.setAttribute('class', 'active');
Third.setAttribute('href', '#');
Third.innerHTML="3"
Third.setAttribute('id', 'thirdId');
Third.setAttribute('onclick', 'tableDisplay(this.id)');

let Fourth = document.createElement('a');
Fourth.setAttribute('href', '#');
Fourth.innerHTML="4"
Fourth.setAttribute('id', 'fourthId');
Fourth.setAttribute('onclick', 'tableDisplay(this.id)');
...
Last.setAttribute('onclick', 'tableDisplay(this.id)');

let lst = ['firstId', 'secondId', 'thirdId', 'fourthId', 'lastId'];


// 
function tableDisplay(clicked_id) {
    var myData = [
        {
          "id": "1",
          "name": "Lura Senger",
    ...
    else if(clicked_id === 'secondId'){
      Second.setAttribute('class', 'a.active');
        for (var i = 20; i < 41; i++) {
    ...
    if(clicked_id === 'thirdId'){
      Third.setAttribute('class', 'a.active');
        for (var i = 40; i < 61; i++) {
    ...
    if(clicked_id === 'fourthId'){
      Fourth.setAttribute('class', 'a.active');
        for (var i = 60; i < 81; i++) {
    ...
    if(clicked_id === 'lastId'){
      Last.setAttribute('class', 'a.active');
        for (var i = 80; i <= 99; i++) {
...
// 
paginationList.append(First,Previous, Second, Third, Fourth, Last);
